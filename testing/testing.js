...
"$RLN77680000+487919234-1224970480+000170330293+0001184908020406001265171A19362458255D295B000000000032;ID=B900;*44<"
];
...
function broadcastNew() {
    ...
    server.send(message, 0, message.length, 5067, "localhost");
